...
public class FrameworkHack
{
                                            ...
                                            boolean kitkatPlus, boolean marshmallowPlus) throws Exception
    {
        ...
        if (marshmallowPlus)
        {
            mMakeDexElements = dplClass.getDeclaredMethod("makePathElements", List.class, File.class, List.class);
        }
        else if (kitkatPlus)
        {
            mMakeDexElements = dplClass.getDeclaredMethod("makeDexElements", ArrayList.class, File.class, ArrayList.class);
        }
        else
        {
